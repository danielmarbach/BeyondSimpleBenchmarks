...
{
        public static Func<TRootContext, Task> CreatePipelineExecutionFuncWithSmugglingAndUnsafeFor<TRootContext>(this IBehavior[] behaviors, List<Expression> expressions = null)
        ...
        static readonly MethodInfo GetBehaviorMethodInfo =
            typeof(BehaviorExtensions).GetMethod("GetBehavior")!;
    }